                                        ...
                                        <tbody>
                                          ...
                                          <tr>
                                            ...
                                            <td colspan="3">
                                              <v-row>
                                                <v-col cols="6">
                                                  <v-checkbox label="TL : Verifikasi Portofolio" v-model="value" value="value"></v-checkbox>
                                                </v-col>
                                                <v-col cols="6">
                                                  <v-checkbox label="L : Observasi Langsung" v-model="value" value="value"></v-checkbox>
                                                </v-col>
                                              </v-row>
                                            </td>
                                          </tr>
                                          <tr>
                                            <td colspan="3">
                                              <v-checkbox readonly class="py-0" label="T: Hasil Tes Tulis" v-model="form.tulis" value="1"></v-checkbox><br>
                                              <v-checkbox readonly class="my-0 py-0" label="T: Hasil Tes Lisan" v-model="form.lisan" value="1"></v-checkbox><br>
                      ...
                      <v-data-table
                          ...
                          <template v-slot:item.actions="{ item }">
                            <v-tooltip bottom>
                              ...
                              <v-tooltip bottom>
                                <template v-slot:activator="{ on }">
                                  <v-btn class="mr-2" v-on="on" icon color="pink darken-3" @click="editItemPortofolio(item)" target="_blank">
                                    <v-icon>
                                      edit
                                    </v-icon>
                                  </v-btn>
                                ...
                                <v-simple-table> 
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td class="success--text" v-if="ujikompetensi[ujiIndex].observasi_date != null">Selesai</td>
                                      <td class="error--text" v-if="ujikompetensi[ujiIndex].observasi_date == null">Belum</td>
                                    </tr>
                                    <tr>
