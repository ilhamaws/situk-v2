                          ...
                          <v-card-text>
                            <v-simple-table>
                              <tbody>
                                ...
                                <tr>
                                  <td colspan="3">
                                    <v-checkbox class="py-0" label="T: Hasil Tes Tulis" v-model="form.tulis" value="1"></v-checkbox><br>
                                    <v-checkbox class="my-0 py-0" label="T: Hasil Tes Lisan" v-model="form.lisan" value="1"></v-checkbox><br>
                      ...
                      <v-expansion-panel-content>
                          ...
                          <v-simple-table> 
                              ...
                              <tr>
                                  ...
                                  <td class="error--text" v-if="ujikompetensi[ujiIndex].verifikasi_am == null">Belum
                                  <v-dialog v-model="tambahDialog" persistent max-width="600px">
                                    <template v-slot:activator="{ on }">
                                      <v-btn @click="verifikasiDialog(uji)" class="ml-2" v-on="on" text x-small fab color="grey">
                                        <v-icon>edit</v-icon>
                                      </v-btn>
                                          ...
                                          <v-container>
                                            <v-row>
                                              <v-col cols="12" sm="12" md="12">
                                                ...
                                                <v-text-field class="mt-2" solo v-model="editedVerifikasi.rekomendasi_am" label="Rekomendasi penilaian asesmen mandiri" required></v-text-field>
                                              </v-col>
                                            </v-row>
                                          </v-container>
                                        </v-card-text>
