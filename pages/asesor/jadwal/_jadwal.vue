    ...
    <section>
      ...
      >
        <v-container fluid>
          <v-card>
            <v-card-title>
              <span class="headline px-5">Verifikasi Peserta</span>
              <v-spacer></v-spacer>
            </v-card-title>
            <v-divider></v-divider>
            <v-row>
                ...
                <div class="px-5 py-5">
                  ...
                  >
                    ...
                    <template #item.asesi.nama="{ item }">
                      ...
                      <nuxt-link :to="`/asesor/peserta/${item.id}`">
...
import { GET_JADWALS_ASESOR, GET_ANGGARANS, GET_PESERTAS_ASESOR, VERIFIKASI_PESERTA_MUTATION } from '../../../constants/graphql'
