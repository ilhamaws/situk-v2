                          ...
                          <v-form>
                            ...
                            <v-row>
                              <v-col md="6" class="py-0">
                                ...
                                <v-row>
                                  <v-col md="7">
                                    <v-text-field readonly label="Edit Foto" persistent-hint="PNG, JPG dengan maksimal 2MB" v-model='image.imageName' @click='pickImage' prepend-icon='mdi-camera' solo></v-text-field>
                                    <input
                                        type="file"
                                        style="display: none"
                                        ref="image"
