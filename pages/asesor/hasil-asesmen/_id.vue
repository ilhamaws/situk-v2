                ...
                <v-simple-table>
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <v-radio-group readonly v-model="pesertas.status" row>
                          <v-radio :value = "2" label="Kompeten"></v-radio>
                          <v-radio :value = "-2" label="Belum kompeten"></v-radio>
                        </v-radio-group>
                      </td>
                      <!-- <td>
                        <v-radio-group readonly v-model="rekaman_asesmen.keputusan" row>
                          <v-radio :value = "true" label="Kompeten"></v-radio>
                    ...
                    <tr v-for="(unit, index) in pesertas.ujiKompetensi" :key="unit.id">
                      ...
                      <td>
                        <div class="d-flex justify-center">
                          <v-checkbox readonly v-model="pesertas.ujiKompetensi[index].rekamanAsesmen.observasi" class="justify-center"></v-checkbox>
                        </div>
                      </td>
                      <td>
                        <div class="d-flex justify-center">
                          <v-checkbox readonly v-model="pesertas.ujiKompetensi[index].rekamanAsesmen.portofolio" class="justify-center"></v-checkbox>
                        </div>
                      </td>
                      <td>
                        <div class="d-flex justify-center">
                          <v-checkbox readonly v-model="pesertas.ujiKompetensi[index].rekamanAsesmen.pihak_ketiga" class="justify-center"></v-checkbox>
                        </div>
                      </td>
                      <td>
                        <div class="d-flex justify-center">
                          <v-checkbox readonly v-model="pesertas.ujiKompetensi[index].rekamanAsesmen.pertanyaan_lisan" class="justify-center"></v-checkbox>
                        </div>
                      </td>
                      <td>
                        <div class="d-flex justify-center">
                          <v-checkbox readonly v-model="pesertas.ujiKompetensi[index].rekamanAsesmen.pertanyaan_tertulis" class="justify-center"></v-checkbox>
                        </div>
                      </td>
                      <td>
                        <div class="d-flex justify-center">
                          <v-checkbox readonly v-model="pesertas.ujiKompetensi[index].rekamanAsesmen.proyek_kerja" class="justify-center"></v-checkbox>
                        </div>
                      </td>
                      <td>
                        <div class="d-flex justify-center">
                          <v-checkbox readonly v-model="pesertas.ujiKompetensi[index].rekamanAsesmen.lainnya" class="justify-center"></v-checkbox>
                        </div>
                      </td>
                    </tr>
                  </tbody>
