                ...
                <tbody v-for="(elemen, elemenIndex) in ujikompetensi.unitKompetensi.element" :key="elemen.id">
                    ...
                    <tr v-for="(kuk, kukIndex) in elemen.kriteriaUk" :key="kuk.id">
                        ...
                        <div class="d-flex justify-center">
                            <v-checkbox readonly v-model="ujikompetensi.unitKompetensi.element[elemenIndex].kriteriaUk[kukIndex].asesmen_mandiri" :value="1"></v-checkbox>
                        </div>
                        </td>
                        <td>
                        <div class="d-flex justify-center">
        ...
        <v-list v-if="ujikompetensi != null" class="pt-5">
            ...
            <tbody>
                <tr>
                    ...
                    <td> 
                        <!-- <img :src="ujikompetensi.peserta.asesi.ttd" alt="" style="width: 500px"> -->
                        <v-img
