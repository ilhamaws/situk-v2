          ...
          <v-card flat>
            ...
            <v-card-text>
              <v-simple-table dense class="table-border">
                <tbody>
                  ...
                  <tr>
                    <td width="30%"><b>Skema sertifikasi</b></td>
            ...
            <v-card-text>
              <v-simple-table class="table-border">
                  ...
                  <tr v-for="(unit, index) in pesertas.ujiKompetensi" :key="unit.id">
                    ...
                    <td>
                      <div class="d-flex justify-center">
                        <v-checkbox v-model="pesertas.ujiKompetensi[index].rekamanAsesmen.observasi" readonly hide-details class="justify-center my-1"></v-checkbox>
                      </div>
                    </td>
                    <td>
                      <div class="d-flex justify-center">
                        <v-checkbox v-model="pesertas.ujiKompetensi[index].rekamanAsesmen.portofolio" readonly hide-details class="justify-center my-1"></v-checkbox>
                      </div>
                    </td>
                    <td>
                      <div class="d-flex justify-center">
                        <v-checkbox v-model="pesertas.ujiKompetensi[index].rekamanAsesmen.pihak_ketiga" readonly hide-details class="justify-center my-1"></v-checkbox>
                      </div>
                    </td>
                    <td>
                      <div class="d-flex justify-center">
                        <v-checkbox v-model="pesertas.ujiKompetensi[index].rekamanAsesmen.pertanyaan_lisan" readonly hide-details class="justify-center my-1"></v-checkbox>
                      </div>
                    </td>
                    <td>
                      <div class="d-flex justify-center">
                        <v-checkbox v-model="pesertas.ujiKompetensi[index].rekamanAsesmen.pertanyaan_tertulis" readonly hide-details class="justify-center my-1"></v-checkbox>
                      </div>
                    </td>
                    <td>
                      <div class="d-flex justify-center">
                        <v-checkbox v-model="pesertas.ujiKompetensi[index].rekamanAsesmen.proyek_kerja" readonly hide-details class="justify-center my-1"></v-checkbox>
                      </div>
                    </td>
                    <td>
                      <div class="d-flex justify-center">
                        <v-checkbox v-model="pesertas.ujiKompetensi[index].rekamanAsesmen.lainnya" readonly hide-details class="justify-center my-1"></v-checkbox>
                      </div>
                    </td>
                  </tr>
                </tbody>
                <tbody>
                  <tr>
                    <td colspan="2"><b>Rekomendasi hasil asesmen</b></td>
                    <td v-if="pesertas.status == 2" colspan="6">Kompeten</td>
                    <td v-if="pesertas.status == -2" colspan="6">Belum Kompeten</td>
                  </tr>
