            ...
            <v-card flat>
              ...
              <tbody>
                  ...
                  <td>
                      ...
                      <v-checkbox readonly v-model="pesertas.ujiKompetensi[index].rekamanAsesmen.observasi" hide-details class="justify-center my-1"></v-checkbox>
                      </div>
                  </td>
                  <td>
                      <div class="d-flex justify-center">
                      <v-checkbox readonly v-model="pesertas.ujiKompetensi[index].rekamanAsesmen.portofolio" hide-details class="justify-center my-1"></v-checkbox>
                      </div>
                  </td>
                  <td>
                      <div class="d-flex justify-center">
                      <v-checkbox readonly v-model="pesertas.ujiKompetensi[index].rekamanAsesmen.pihak_ketiga" hide-details class="justify-center my-1"></v-checkbox>
                      </div>
                  </td>
                  <td>
                      <div class="d-flex justify-center">
                      <v-checkbox readonly v-model="pesertas.ujiKompetensi[index].rekamanAsesmen.pertanyaan_lisan" hide-details class="justify-center my-1"></v-checkbox>
                      </div>
                  </td>
                  <td>
                      <div class="d-flex justify-center">
                      <v-checkbox readonly v-model="pesertas.ujiKompetensi[index].rekamanAsesmen.pertanyaan_tertulis" hide-details class="justify-center my-1"></v-checkbox>
                      </div>
                  </td>
                  <td>
                      <div class="d-flex justify-center">
                      <v-checkbox readonly v-model="pesertas.ujiKompetensi[index].rekamanAsesmen.proyek_kerja" hide-details class="justify-center my-1"></v-checkbox>
                      </div>
                  </td>
                  <td>
                      <div class="d-flex justify-center">
                      <v-checkbox readonly v-model="pesertas.ujiKompetensi[index].rekamanAsesmen.lainnya" hide-details class="justify-center my-1"></v-checkbox>
                      </div>
                  </td>
                  </tr>
              </tbody>
              <tbody>
                <tr>
                  ...
                  <td colspan="6" v-if="pesertas.status == 2">Kompeten</td>
                  <td colspan="6" v-if="pesertas.status == -2">Belum Kompeten</td>
                </tr>
