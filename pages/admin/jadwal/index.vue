          ...
          <v-row>
            <v-col cols="12" class="px-10 py-5">
              <div class="px-5 py-5">
                ...
                <template v-slot:item.tempatUk.nama="{ item }">
                ...
                <template v-slot:item.skema.skema="{ item }">
                ...
                <template v-slot:item.jurusan.jurusan="{ item }">
                  <ul>
                    <li v-for="(jurusan, i) in item.jurusan">
