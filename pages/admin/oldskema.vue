                ...
                <v-row>
                  <v-dialog v-model="tambahDialog" persistent max-width="600px">
                    ...
                    <v-card>
                        ...
                        <v-container>
                          <v-row>
                            <v-col cols="12" sm="12" md="12">
                              <v-text-field v-model="form.skema" label="Nama Skema*" required></v-text-field>
                            </v-col>
                            <v-col cols="12" sm="6" md="6">
                              <v-text-field v-model="form.kode" label="Kode*" hint="example of helper text only on focus"></v-text-field>
                            </v-col>
                            <v-col cols="12" sm="6" md="6">
                              <v-text-field v-model="form.kategori" label="Kategori*" hint="example of helper text only on focus"></v-text-field>
                            </v-col>
                            <v-col cols="12" sm="12" md="12">
                              <v-text-field v-model="form.bidang" label="Bidang*" hint="example of helper text only on focus"></v-text-field>
                            </v-col>
                            <v-col cols="12" sm="6" md="6">
                              <v-select
                                v-model="form.mea"
                            ...
                            <v-col cols="12" sm="12" md="12">
                              <v-text-field :label="'Upload Panduan .pdf'" :value='panduan.panduanName' @click="pickPanduan" prepend-icon='attach_file'></v-text-field>
                              <input
                                  type="file"
                                  style="display: none"
                                  ref="panduan"
                      ...
                      <v-card-actions>
                        <v-spacer></v-spacer>
                        <v-btn color="blue darken-1" text @click="tambahDialog = false, panduan.panduanName = '', panduan.panduanFile = '', panduan.panduanUrl = ''">Close</v-btn>
                    ...
                    <v-card>
                      ...
                      <v-card-text>
                        <v-container>
                          <v-row>
                            <v-col cols="12" sm="12" md="12">
                              <v-text-field v-model="editedSkemas.skema" label="Nama Skema*" required></v-text-field>
                            </v-col>
                            <v-col cols="12" sm="6" md="6">
                              <v-text-field v-model="editedSkemas.kode" label="Kode*" hint="example of helper text only on focus"></v-text-field>
                            </v-col>
                            <v-col cols="12" sm="6" md="6">
                              <v-text-field v-model="editedSkemas.kategori" label="Kategori*" hint="example of helper text only on focus"></v-text-field>
                            </v-col>
                            <v-col cols="12" sm="12" md="12">
                              <v-text-field v-model="editedSkemas.bidang" label="Bidang*" hint="example of helper text only on focus"></v-text-field>
                            </v-col>
                            <v-col cols="12" sm="6" md="6">
                              <v-select
                      ...
                      <v-card-actions>
                        <v-spacer></v-spacer>
                        <v-btn color="blue darken-1" text @click="editDialog = false, panduan.panduanName = '', panduan.panduanFile = '', panduan.panduanUrl = ''">Batal</v-btn>
    ...
    methods: {
      onPanduanSelected(type, e) {
        ...
        if(panduanFile[0] !== undefined) {
            ...
            fr.addEventListener('load', () => {
                ...
                if (type == 'edit'){
                  this.editedSkemas.panduan = fr.result;
                }
      ...
      editItem(item) {
        ...
        if (this.editedSkemas.tempatUk == null) {
          this.editedSkemas.tempatUk = Object.assign({}, {id: ''});
        }
      ...
      async updateSkema() {
        this.alert.show = false;
        const { editedSkemas: {id, kode, skema, kategori, bidang, panduan, mea} } = this.$data;
