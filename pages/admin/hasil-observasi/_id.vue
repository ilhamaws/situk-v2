                        ...
                        <v-expansion-panel-content>
                            ...
                            <v-simple-table> 
                                ...
                                <tr>
                                    ...
                                    <td class="success--text" v-if="ujikompetensi[ujiIndex].verifikasi_am != null">Selesai</td>
                                    <td class="error--text" v-if="ujikompetensi[ujiIndex].verifikasi_am == null">Belum</td>
                                </tr>
                                <tr>
                                    <td width="20%"><b>Umpan balik observasi:</b></td>
                                    <td>{{ ujikompetensi[ujiIndex].umpan_balik_obervasi }}</td>
                                </tr>
                                </tbody>
                            </v-simple-table>
                            <v-simple-table>
                                ...
                                <tbody v-for="(elemen, elemenIndex) in uji.unitKompetensi.element" :key="elemen.id">
                                    ...
                                    <tr v-for="(kuk, kukIndex) in elemen.kriteriaUk" :key="kuk.id">
                                      ...
                                      <td colspan="2" class="text-center">
                                        <v-radio-group readonly row v-model="ujikompetensi[ujiIndex].unitKompetensi.element[elemenIndex].kriteriaUk[kukIndex].observasi">
                                          <v-col cols="6">
                            ...
                            <v-row>
                                <v-col class="d-flex justify-end">
                                    <v-btn target="_blank" :href="`/admin/print/checklist-observasi/${ujikompetensi[ujiIndex].id}`" color="primary" outlined dark ><v-icon left>print</v-icon>Print</v-btn>
                                </v-col>
                            </v-row>
                            <!-- <v-row>
                                <v-col class="d-flex justify-end">
                                    <v-btn target="_blank" color="primary" outlined dark ><v-icon left>print</v-icon>Print</v-btn>
                                </v-col>
                            </v-row> -->
                        </v-expansion-panel-content>
                    </v-expansion-panel>
                ...
                for (let j = 0; j < this.ujikompetensi[x].unitKompetensi.element[i].kriteriaUk.length; j++) {
                  ...
                  for (let k = 0; k < this.ujikompetensi[x].asesmen.length; k++) {
                    if (this.ujikompetensi[x].observasi[k].kriteriaUk.id == kuk.id) {
                      ...
                      this.ujikompetensi[x].unitKompetensi.element[i].kriteriaUk[j] = Object.assign({}, this.ujikompetensi[x].unitKompetensi.element[i].kriteriaUk[j], { observasi: `${this.ujikompetensi[x].observasi[k].observasi}`, penilaian_lanjut: `${this.ujikompetensi[x].observasi[k].penilaian_lanjut}` });
