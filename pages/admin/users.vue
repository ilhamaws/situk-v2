                        ...
                        <v-container>
                          <v-row>
                            <v-col cols="12" sm="12" md="12">
                              <v-text-field :rules="emailRules" v-model="form.email" label="Email*" required></v-text-field>
                            </v-col>
                            <v-col cols="12" sm="6" md="6">
                              <v-text-field :rules="passwordRules" v-model="form.password" type="password" label="Password*" hint="Minimal 5 karakter"></v-text-field>
                            </v-col>
                            <v-col cols="12" sm="6" md="6">
                              <v-select
                                :items="roles"
                    ...
                    <v-card>
                      ...
                      <v-card-text>
                        <v-container>
                          <v-row>
                            <v-col cols="12" sm="12" md="12">
                              <v-text-field :rules="emailRules" v-model="editedUser.email" label="Email*" required></v-text-field>
                            </v-col>
                            <v-col cols="12" sm="6" md="6">
                              <v-select
                                readonly
                            ...
                            <v-col cols="12" sm="6" md="6">
                              <v-text-field required :rules="passwordRules" v-model="editedUser.password" type="password" label="Password*" hint="Minimal 5 karakter"></v-text-field>
                            </v-col>
                          </v-row>
                        </v-container>
                        <small>*Wajib diisi</small>
